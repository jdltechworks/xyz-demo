...
export default class ProjectsArchivedView extends Component {
  componentDidMount() {
    let { props } = this;
    let { projects: project, fetchArchivedProjects } = props;
    fetchArchivedProjects();
  }
  render() {
    let { props } = this;
    let { location: { pathname }, projects: { isLoading, collection} } = props;
    if(!isLoading) {
