...
export default class ProductsCheckedOutView extends Component {
  componentDidMount() {
    let { fetchCheckedOutProducts, numOfProducts } = this.props;
  ...
  render() {
    ...
    let { products } = props;
    let { 
      products: { collection, modal, isLoading, isFiltered, isSearching, isGrid },
    } = props;
