...
import { exec_action, add_to_project } from './actions';

import { toggleClass, toggleLocation } from './toggle';

export default class CheckedOutInLocation extends Component {
        ...
        {!project_data ?
          ...
          <div className="checkout-location-btn">
            <div className="tool-btns">
              <span className="tool-btn lock-btn btn-to-hide" onClick={toggleLocation.bind(this, 'location')}><em className="icon icon-location"></em></span>
              <span onClick={toggleClass.bind(this, 'inlocation')} className="tool-btn add-btn"><em className="icon icon-add"></em></span>
            </div>
            <ul className="tool-tap">
              <li><em className="icon icon-lock"></em>UNTIL {moment(new Date(endDate)).format('MM.DD.YY')}</li>
              <li><em className="icon icon-location"></em>{address().toUpperCase()}</li>
            </ul>
          </div>
            : null
          : 
          <div className="tool-btns">
            ...
            <span className="tool-btn lock-btn btn-to-hide"><em className="icon icon-location"></em></span>
...
CheckedOutInLocation.contextTypes = {
